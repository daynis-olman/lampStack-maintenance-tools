...
MYSQLBIN="/opt/bitnami/mysql/bin/mysql"
MYSQLUSER="ENTER-MYSQL-DB-USERNAME-HERE"
MYSQLPASS="ENTER-MYSQL-DB-PASSWORD-HERE"
MYSQLDB="ENTER-MYSQL-DB-NAME-HERE"
BIN="/home/bitnami/apps/bin"
DOWNLOADDIR="/home/bitnami/apps/logs/backup"
...
$PHPCMD $BIN/prod-aws-s3-download.php -d $BACKUP_DATE -b $S3_BUCKET -p $S3_BUCKET_FOLDER -f $S3_BUCKET_FILE
NOW=$(date +"%Y-%m-%d %H:%M:%S")
#
